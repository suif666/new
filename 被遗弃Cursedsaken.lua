...
local Translations = {
    ...
    ["Base Speed"] = "基础速度",
    ["Apply Changes"] = "应用更改",
    ["Stamina system (Survivor)"] = "体力类（幸存者）",
    ["Stamina system (Killer)"] = "体力类（杀手）",
    ["Stamina Stats"] = "体力属性",
    ["Stamina Staff"] = "体力加成",
    ["Stamina management"] = "体力管理",
    ["Enable Stamina Max"] = "修改体力上限",
    ["Max Stamina Value"] = "体力上限值",
    ["Enable Stamina Gain"] = "修改体力恢复",
    ["Stamina Gain Value"] = "体力恢复值",
    ["Enable Stamina Loss"] = "修改体力消耗",
    ["Stamina Loss Value"] = "体力消耗值",
    ["Enable Sprint Speed"] = "修改奔跑速度",
    ["Sprint Speed Value"] = "奔跑速度值",
    ["Enable k-Stamina Max"] = "修改杀手体力上限",
    ["Max k-Stamina Value"] = "杀手体力上限值",
    ["Enable k-Stamina Gain"] = "修改杀手体力恢复",
    ["Stamina k-Gain Value"] = "杀手体力恢复值",
    ["Enable k-Stamina Loss"] = "修改杀手体力消耗",
    ["Stamina k-Loss Value"] = "杀手体力消耗值",
    ["Enable k-Sprint Speed"] = "修改杀手冲刺速度",
    ["Sprint k-Speed Value"] = "杀手冲刺速度值",
    ["Load Recommended stats"] = "导入推荐数值",
    ["Load Blatant Stats"] = "导入暴力数值",
    ["Reset Settings"] = "重置设置",
    ["Infinite Stamina"] = "无限体力",
    ["No Stamina Penalty"] = "无体力惩罚",
    ["Always Sprint"] = "保持奔跑状态",
    ["Show Legit Stamina View"] = "正常体力消耗[视觉]",
    ["Enable Stamina Management"] = "启用体力管理",
    ...
    ["Builderman Sentry/Dispenser color"] = "Builderman 炮塔/补给器颜色",
    ...
    ["Builderman Sentry/Dispenser"] = "Builderman 炮塔/补给器",
    ...
    ["Auto Parry"] = "自动格挡",
    ["Charge"] = "蓄力",
    ["Enable Attack Visualizer (Legit)"] = "攻击距离可视化",
    ["Show Ping Checker"] = "显示延迟",
    ["Block Mode"] = "格挡模式",
